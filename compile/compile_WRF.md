...
Use `python compile_WRF.py --help` for a quick summary of all installation options, and see sections below for a more detailed description.
...
> [!NOTE]
> This script creates and run a compilation script (`compile.job`) in the cloned repository. It also creates there a file (`compile.json`) that lists the compilation options.

# Description of all the options

> [!TIP]
> The example JSON file given in the next section lists all the default values.
